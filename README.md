...
A RESTful API built with Spring Boot for managing helpdesk users, supporting two user types: **Customers** and **Service Providers**.
...
```json
{
  ...
  "availableSlotHours": [8, 9, 10, 14, 17]
}
```
